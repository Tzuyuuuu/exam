...
const questions = [
  ...
  },
  {
    ...
    options: [
      { text: "撿起路邊的木棍......", value: "風紀" },
      { text: "沒關係，再忍耐一下下，安慰自己快結束了", value: "學藝" },
      { text: "假裝昏倒，順便躲進保健室睡個回籠覺", value: "衛生" },
      { text: "偷偷跟隔壁同學抱怨", value: "值日生" },
    ],
  },
  {
    text: "第一節居然是數學課！╰(〒皿〒)╯黑板上面的數字和符號好像在跳舞......",
    options: [
  ...
  {
    text: "午餐時間到了，但大雞腿和布丁的數量好像出了問題，排到你時剛好被前面同學拿走最後一份......",
    options: [
      {
        text: "學笑怎麼可以出這種問題，造成同學營養不良該怎麼辦? 立刻跟老師反映",
        value: "班長",
      },
      { text: "和前面同學打個商量，一起平分", value: "康樂" },
      { text: "撿起路邊的木棍......", value: "風紀" },
      {
        text: " 算了，今天還是減肥好了，不要吃那麼多",
        value: "值日生",
      },
    ],
  },
  {
    text: "下午該去福利社一趟了吧! 面對琳瑯滿目的商品......",
    options: [
      { text: "鬆軟香甜的蘋果麵包，一定能讓下午上課更有精神", value: "學藝" },
      { text: "這麼熱的天氣，當然要來一瓶芭芒柳消消暑", value: "班長" },
      { text: "中午沒吃飽，買個肉羹麵上課偷吃", value: "康樂" },
      {
        text: "撿起路邊的木棍......",
        value: "風紀",
      },
  ...
  {
    text: "準備放學了，今天跟同學約好放學一起去公園玩鬼抓人，但大家好像對這個遊戲的名字沒有共識......",
    options: [
